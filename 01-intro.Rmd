...
The difference between an explanatory and response variable often depends on the motivation and/or study design. For example if we where interested to know if fertilizer type had an (?indirect?) impact on insect deversity, the type of fertilizer would be the explanatory variable and the number of insect species per hectare would be the response variable.
