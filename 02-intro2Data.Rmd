...
--- JK ideas
Determine which of the following studies are experimental. If they are, explain why. If they are not, explain why not, or describe how they could be modified to be experimental? 
a) ...

Consider the final panel of the cartoon above. What could be modified in the panel to make the study experimental? What could be modified in the panel to exemplify sampling error instead of bias? 
