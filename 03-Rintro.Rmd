...
```{r collecting, fig.cap='R as a calculator, intro to vectors (3 min 47 sec).', echo=FALSE, out.extra= 'allowfullscreen'}
include_url("https://www.youtube.com/embed/gkxE57xGmuc)
``` 
