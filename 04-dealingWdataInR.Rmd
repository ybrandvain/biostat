...
We can filter by any set of logical questions like greater then `>`, greater then or equal to `>=`, less than `<`, not equal `!=`, in a vector `%in%` etc... (see Ch \@ref(intro2r) for more info).   
