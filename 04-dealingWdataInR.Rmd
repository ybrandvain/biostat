...
**Learning goals: By the end of this chapter you should be able to get data  into `R` and explore it**. Specifically, stiduents will be able to:
...
Let's say we didnt care about height of weight, and we just wanted individual, species, sound, and BMI. We can  [`select()`](https://dplyr.tidyverse.org/reference/select.html) those columns as follows: 
