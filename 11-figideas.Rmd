...
In addition to this reading, watching the embedded videos on [telling a good story](https://youtu.be/geG8E_ocYDY), [misleading by truncating your axes](https://youtu.be/9pNWVMxaFuM), [misleading by messing with bin size](https://www.youtube.com/watch?v=zAg1wsYfwsM&feature=youtu.be), and trying [these data](https://github.com/ybrandvain/biostat/blob/master/images/homglobin4comp.png?raw=true) on the [color vision deficiency simulator](http://hclwizard.org/cvdemulator/)  **you should think hard about your figures, the story you want them to tell, and how you would emphasize that story in your plots**. 
```
...
You will then go back and forth with you pencil and paper and ggplot with a few iterations until you have a plot you like (See Figure \@ref(fig:evo) for an example, and the [blog it came from](https://cedricscherer.netlify.app/2019/05/17/the-evolution-of-a-ggplot-ep.-1/) for how they did it).
...
####  Make labels informative, easy to digest, and readable {#goodlabels}
...
```{r, fig.cap = "oops", echo=FALSE}
include_graphics("https://pbs.twimg.com/media/EtmtwHHUUAAGV2C?format=jpg&name=small")
```
